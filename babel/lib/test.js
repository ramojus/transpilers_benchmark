...
fetchData();
var promises = [Promise.resolve(1), Promise.reject('Error'), Promise.resolve(3)];
...
(_obj$prop = obj.prop1) === null || _obj$prop === void 0 || (_obj$prop = _obj$prop.prop2) === null || _obj$prop === void 0 || _obj$prop.prop3;
var foo = null;
...
Promise.resolve('resolved')["finally"](function () {});